...
RSpec.describe TestAnswersController, :type => :controller do
  ...
  let(:test) { create(:reading_test) }
  let(:user) { create(:user) }
  # This should return the minimal set of attributes required to create a valid
  # TestAnswer. As you add validations to TestAnswer, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) {
    attributes_for(:test_answer, user_id: user.id, reading_test_id: test.id)
  }

  let(:invalid_attributes) {
    attributes_for(:test_answer, user_id: user.id, reading_test_id: test.id, answer: '')
  }
  ...
  describe "GET show" do
    it "assigns the requested test_answer as @test_answer" do
      test_answer = TestAnswer.create! valid_attributes
      get :show, {:id => test_answer.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested test_answer as @test_answer" do
      test_answer = TestAnswer.create! valid_attributes
      get :edit, {:id => test_answer.to_param}, valid_session
      expect(assigns(:test_answer)).to eq(test_answer)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new TestAnswer" do
        expect {
          post :create, {:test_answer => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved test_answer as @test_answer" do
        post :create, {:test_answer => invalid_attributes}, valid_session
        expect(assigns(:test_answer)).to be_a_new(TestAnswer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested test_answer" do
        test_answer = TestAnswer.create! valid_attributes
        put :update, {:id => test_answer.to_param, :test_answer => new_attributes}, valid_session
        test_answer.reload
      ...
      it "assigns the requested test_answer as @test_answer" do
        test_answer = TestAnswer.create! valid_attributes
        put :update, {:id => test_answer.to_param, :test_answer => valid_attributes}, valid_session
        expect(assigns(:test_answer)).to eq(test_answer)
      end
    ...
    describe "with invalid params" do
      it "assigns the test_answer as @test_answer" do
        test_answer = TestAnswer.create! valid_attributes
        put :update, {:id => test_answer.to_param, :test_answer => invalid_attributes}, valid_session
        expect(assigns(:test_answer)).to eq(test_answer)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested test_answer" do
      test_answer = TestAnswer.create! valid_attributes
      expect {
        delete :destroy, {:id => test_answer.to_param}, valid_session
      }.to change(TestAnswer, :count).by(-1)
    end
