Given(/^chinese texts in database$/) do
  @text1 = FactoryGirl.create(:text, title: "灾区群众作诗赠总书记" ,content: "【灾区群众作诗赠总书记】看到总书记，当地干部群众十分激动。一位干部说，明天是大寒节气，大伙连夜自发创作了一首诗送给总书记：“大寒节令送大爱，龙头喜降丰年雪，千户万户瞳瞳日，十万乌蒙尽开颜”。现场响起热烈的掌声。望着远处被白雪覆盖的山峦，总书记感叹，这里地理条件确实复杂。
